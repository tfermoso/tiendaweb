window.onload = function () {
    ...
    function mostrarProductos(productos) {
        ...
        for (let i = 0; i < productos.length; i++) {
            ...
            <div>
                <img src="static/img/borrar.jpg" id="btnEliminar${productos[i].id}" class="btnBorrar" alt=""></div>
                <a href="editarproducto?id=${productos[i].id}"><img src="static/img/editar.png" id="btnEditar" class="btnEditar"></a>
            </div>`;
        }
